...
public isolated function generateISOMessage(json isoRecord) returns string|ISOError {
    
    string|iso8583:ISO8583Exception iso8583String = iso8583:ISO8583ParserUtil_generateISOMessage(isoRecord.toString());
